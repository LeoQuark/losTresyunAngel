...
<head>
	...
	<style>
		body {
			padding-top: 90px;
			background: linear-gradient(to right, #171d4b, #00a196, #2ed3c6, #00a196, #171d4b);
		}
						...
						<div class="row">
							<div class="col-lg-12">
								...
								<form id="register-form" action="registrar.php" method="post" role="form" style="display: none;">
									<div class="form-group">
										<input type="text" name="email" id="email" tabindex="1" class="form-control" placeholder="Rut" value="" required>
									</div>
									<div class="form-group">
										<input type="password" name="pass" id="pass" tabindex="2" class="form-control" placeholder="Contraseña" required>
									</div>
